...
import { clickButton, isPageOpened } from '../page_objects/product-move';
...
When(/Click on (.*) Button/, (buttonName) => { clickButton(buttonName); });
When(/^I open '([a-zA-Z ]*)' widget$/, (widgetName) => { openWidget(widgetName); });
When(/Order validation step is open/, () => { isPageOpened(); });
